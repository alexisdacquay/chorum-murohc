...
| Read or advance level | Deny | Allow own read and own atomic level-up after approved T061 policy | No mutation; allow own-household level summary through T084 | T061 to T064, T084; the client never supplies cost or resulting level |
